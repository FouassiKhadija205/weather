...
function Grp204WeatherApp() {
  ...
  return (
    <div className="App">
      <h1 className="app-name">Application Météo FOUASSI KHADIJA</h1>
      ...
      {/* Display favorite cities anstyle={{ marginBottom: '10px' }}d make them clickable */}
        ...
        <div>
          ...
          {favoriteCities.map((city, index) => (
            <div key={index} id='a'>
              ...
              <button onClick={() => removeFavoriteCity(city)} style={{ marginLeft: '10px'}} id='btn'>
                Supprimer
              </button>
            </div>
          ))}
      ...
      <div className="forecast">
        <h3>Prévisions pour les 5 jours à venir</h3>
